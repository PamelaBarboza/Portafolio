  ...
  return (
    <div id="sobreMi">
      ...
      <p>
        ...
        <br />
        <br />
        Entre mis fortalezas yo destaco mi perseverancia y mi poder para superar
        la frustración. Mi mayor desafío, porque más que una debilidad es un
        desafío, es el manejo de mi ansiedad, pero trabajo constantemente en
        ello. <br />
        <br />
